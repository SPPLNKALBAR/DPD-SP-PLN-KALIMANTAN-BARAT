  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass-nav h-20 px-6 md:px-12 flex items-center">
      ...
      <div className="flex-1 flex items-center">
        <div className="flex items-center gap-5 cursor-pointer relative group" onClick={() => onTabChange('home')}>
      ...
      <div className="lg:hidden">
        <button className="p-3 rounded-2xl bg-slate-50 text-slate-600">
